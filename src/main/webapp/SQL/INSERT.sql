...
29900, 'F', 'T', 'SH', '432614_1.png', '432614_2.png', '432614_3.png', '432614_4.png', '432614_5.png');
...
· 개폐가 가능한 스냅 버튼으로 변경.
· 소매 밑단 부분은 파이핑 처리.', 
39900, 'F', 'T', 'OT', '429667_1.png', '429667_2.png', '429667_3.png', '429667_4.png', '429667_5.png');
...
29900, 'F', 'T', 'SH', '431976_1.png', '431976_2.png', '431976_3.png', '431976_4.png', '431976_5.png');
...
· 네크라인의 립 폭은 굵게 디자인.', 
19900, 'F', 'T', 'SH', '424873_1.png', '424873_2.png', '424873_3.png', '424873_4.png', '424873_5.png');

INSERT INTO product 
VALUES ('415693', '감탄팬츠(울트라라이트)', '모든 씬에서 착용하기 좋은 고기능의 감탄팬츠. · 아담 스콧 선수와 공동 개발. · 여름 모직과 같은 질감. · 이지케어 가공 처리. · 초속건, 초경량 사양.', 49900, 'M', 'B', 'LP', '415693_1.png', '415693_2.png', '415693_3.png', '415693_4.png', '415693_5.png');

INSERT INTO product  
VALUES ('435455', 'JWA울블렌드노턱팬츠', '심플하지만 고급스러우면서도 품위있어 보이는 인상을 주는 울블렌드 노턱 팬츠. · 고급스러우면서도 경량화를 실현한 울 블렌드 소재. · 심플한 스트레이트 실루엣으로 다양한 스타일과 매치', 59900, 'M', 'B', 'LP', '435455_1.png', '435455_2.png', '435455_3.png', '435455_4.png', '435455_5.png');

INSERT INTO product 
VALUES ('430876', 'U울블렌드저지팬츠(세트업)', '고급스러운 실루엣의 울 블렌드 저지 팬츠. · 혁신적인 소재와 현대적인 디자인으로 재해석한 Uniqlo U 컬렉션. · 스트레치성 있는 울 블렌드 더블 페이스 소재 사용. · 허리 안쪽에 미끄럼 방지를 부착하여 상의를 넣어 연출', 69900, 'M', 'B', 'LP', '430876_1.png', '430876_2.png', '430876_3.png', '430876_4.png', '430876_5.png');

INSERT INTO product
VALUES ('425137', '스트레치울팬츠(세트업)', '클래식한 디자인을 즐길 수 있는 스트레치 울 팬츠. · 고품질의 「Super110」 모직 소재 사용. · 레귤러 피트 사양.', 89900, 'M', 'B', 'LP', '425137_1.png', '425137_2.png', '425137_3.png', '425137_4.png', '425137_5.png');

INSERT INTO product 
VALUES ('428335', '스웨트팬츠', '깔끔한 실루엣이면서도 캐주얼한 스타일에 제격인 스웨트 팬츠. · 코튼 X 폴리에스터 혼합 소재 사용. · 테이퍼드 실루엣. · 웨이스트는 사이즈 조절이 가능하 스핀들 코드 추가.', 29900, 'F', 'B', 'LP', '428335_1.png', '428335_2.png', '428335_3.png', '428335_4.png', '428335_5.png');

INSERT INTO product 
VALUES ('426284', '슬라우치테이퍼드앵클진(릴랙스피트)', '새로운 실루엣과 빈티지 가공을 더해 트렌디한 인상을 주는 슬라우치 테이퍼드 앵클 진. · 카이하라사 면 소재 100%의 데님 원단 사용. · 슬라우치 실루엣(릴랙스 피트) 디자인. · 밑단은 테이퍼드 실루엣.', 49900, 'F', 'B', 'LP', '426284_1.png', '426284_2.png', '426284_3.png', '426284_4.png', '426284_5.png');

INSERT INTO product 
VALUES ('429094', '울트라스트레치진20FW', '신축성이 있어 움직임이 편하면서도 아름다운 실루엣을 연출할 수 있는 울트라 스트레치 진. · 울트라 스트레치 데님 원단 사용. · 스트레치 원사를 사용 · 스키니피트 테이퍼드 실루엣. · 밑위는 약간 깊게 설정하고, 직선 벨트로 변경하여 깔끔한 인상. · 백포켓의 크기와 모양, 위치를 설정하여 아름다운 뒷모습 연출.', 49900, 'F', 'B', 'LP', '429094_1.png', '429094_2.png', '429094_3.png', '429094_4.png', '429094_5.png');

INSERT INTO product 
VALUES ('418873', '히트텍울트라스트레치레깅스팬츠', '부드러우면서도 따뜻한 착용감을 자랑하는 히트텍 울트라 스트레치 레깅스 팬츠. · 히트텍 소재의 울트라 스트레치 원단 사용. · 깊은 라이즈 설정. · 웨이스트 밴드 사양. · 안감은 기모 소재 사용. · 흡습, 발열 기능.', 39900, 'F', 'B', 'LP', '418873_1.png', '418873_2.png', '418873_3.png', '418873_4.png', '418873_5.png');

INSERT INTO product 
VALUES 
('425142', '치노쇼트팬츠', '트렌디한 여유감 있는 실루엣으로 설정하여 캐주얼한 스타일에 제격인 치노 쇼트 팬츠. 면 소재 100% 사용.', 
29900, 'M', 'B', 'SP', '425142_1.png', '425142_2.png', '425142_3.png', '425142_4.png', '425142_5.png');

INSERT INTO product 
VALUES 
('427823', '저지이지쇼트팬츠D', '부드러우면서도 편한 착용감을 느낄 수 있는 저지 이지 쇼트 팬츠. 면 소재 100%의 저지 원단 사용.', 
19900, 'M', 'B', 'SP', '427823_1.png', '427823_2.png', '427823_3.png', '427823_4.png', '427823_5.png');

INSERT INTO product 
VALUES 
('424420', 'KIDS이지쇼트팬츠', '시원하면서도 편한 착용감을 자랑하는 이지 쇼트 팬츠. 움직임이 더욱 편안한 실루엣으로 변경되었습니다. 면 소재 100% 사용. 웨이스트 왼편에는 밴드 교체용 홀 추가.', 
7900, 'M', 'B', 'SP', '424420_1.png', '424420_2.png', '424420_3.png', '424420_4.png', '424420_5.png');

INSERT INTO product 
VALUES 
('427819', '드라이스트레치이지쇼트팬츠C', '땀을 흘려도 끈적이지 않아 편한 착용감을 느낄 수 있는 드라이 스트레치 이지 쇼트 팬츠. 저지 소재 사용. 드라이 기능. 신축성이 있어 움직임이 편합니다.', 
9900, 'M', 'B', 'SP', '427819_1.png', '427819_2.png', '427819_3.png', '427819_4.png', '427819_5.png');
...
29900, 'M', 'B', 'SP', '422975_1.png', '422975_2.png', '422975_3.png', '422975_4.png', '422975_5.png');

INSERT INTO product
VALUES ('430812', 'JWA보아후리스블루종', '클래식한 양가죽 재킷에서 영감을 받아 모던한 느낌을 더했습니다.
· 가벼운 양털을 두꺼운 니트 위에 겹쳐 따뜻하고 편안한 옷을 입어보세요.
· 트렌디한 쇼트 기장으로 깔끔한 실루엣.
유니클로의 심플한 고품질 옷에 JW ANDERSON의 혁신적인 디자인이 더해진 라이프웨어를 만나보세요!', 59900, 'F', 'T', 'OT', '430812_1.png', '430812_2.png', '430812_3.png', '430812_4.png', '430812_5.png');

INSERT INTO product 
VALUES ('424589', '릴랙스트렌치코트', '클래식한 디자인이면서도 여유감 있는 실루엣으로 설정하여 트렌디한 인상을 주는 릴랙스 트렌치 코트.
· 내구발수 가공 처리.
· 볼륨 실루엣.', 59900, 'F', 'T', 'OT', '424589_1.png', '424589_2.png', '424589_3.png', '424589_4.png','424589_5.png');
...
· 빈티지한 디자인의 허리 벨트 사양.
· 2개 실을 혼합하여 울과 같은 음영과 깊이 있는 색감을 표현했습니다.', 149000, 'M', 'T', 'OT', '432054_1.png', '432054_2.png', '432054_3.png', '432054_4.png', '432054_5.png');
...
· 엄격한 품질 관리로 만들어져 일상을 럭셔리하게 연출해줍니다.
· 크루넥 타입.
· 소매 밑단의 립 부분을 길게 설정하여 손목이 가늘어 보입니다.', 99900, 'F', 'T', 'KN', '428866_1.png', '428866_2.png', '428866_3.png', '428866_4.png', '428866_5.png');
...
VALUES ('429067', 'EFM터틀넥스웨터(긴팔)', 
        '섬세하면서도 우아한 감촉을 느낄 수 EFM 터틀넥 스웨터. 19.5 마이크로 극세 메리노 울 소재 100% 사용. 워셔블(물세탁) 사양. 칼라 높이를 낮게 설정하여 편한 착용감을 느낄 수 있습니다. 어깨에서부터 소매 밑단으로 갈수록 짜임을 단계적으로 설정하여 편한 착용감을 느낄 수 있습니다. 터틀넥 타입.', 
        39900, 'M', 
        'T', 'KN', '429067_1.png', '429067_2.png', '429067_3.png', '429067_4.png', '429067_5.png');
        
INSERT INTO product 
VALUES ('419196', '프리미엄램스울V넥가디건(긴팔)', 
        '소재의 원료를 변경하여 더욱 부드러운 감촉을 느낄 수 있는 프리미엄 램스울 V넥 가디건. 19.5 마이크로 프리미엄 램스울 소재 100% 사용. V넥 타입.', 
        49900, 'M', 
        'T', 'KN', '419196_1.png', '419196_2.png', '419196_3.png', '419196_4.png', '419196_5.png');
        
INSERT INTO product
VALUES ('435798', '캐시미어크루넥스웨터(긴팔)', 
        '섬유의 보석이라 불리우는 캐시미어 소재를 사용하여 부드러우면서도 따뜻한 감촉을 느낄 수 있는 캐시미어 크루넥 스웨터. 캐시미어 소재 100% 사용. 크루넥 타입.', 
        99900, 'M', 
        'T', 'KN', '435798_1.png', '435798_2.png', '435798_3.png', '435798_4.png', '435798_5.png');
...
소매 브라우징 부분을 넉넉하게 설정하여 편안한 착용감 실현!', 19900, 'M', 'T', 'SH', '430015_1.png', '430015_2.png', '430015_3.png', '430015_4.png', '430015_5.png');

INSERT INTO product 
VALUES ('429179', '와플크루넥T(긴팔)', '캐주얼한 스타일에 제격인 와플 크루넥 T셔츠. 디자인의 포인트가 되는 가슴 포켓 추가. 표면에 큰 요철감을 느낄 수 있는 와플 소재 사용.
밑단은 라운트 테일 디자인.',12900,'M', 'T', 'SH', '429179_1.png', '429179_2.png', '429179_3.png', '429179_4.png', '429179_5.png');
...
클래식한 스티치를 채용하였습니다. 드룝 숄더 사양으로 편한 착용감을 느낄 수 있습니다. 편리한 가슴 포켓 사양.',29900,'M', 'T', 'SH', '425213_1.png', '425213_2.png', '425213_3.png', '425213_4.png', '425213_5.png');
...
39900, 'F', 'B', 'SK', '433113_1.png', '433113_2.png', '433113_3.png', '433113_4.png', '433113_5.png');

INSERT INTO product 
VALUES ('432733', '3D니트EFM립플레어스커트', '고급스러우면서도 섬세한 감촉을 즐길 수 있는 3D 니트 EFM 립 플레어 스커트. 고급스러운 광택감을 느낄 수 있는 메리노 울 소재 100% 사용. 홀가먼트 기술 채용. 따끔따끔하지 않은 감촉 실현. 플레어 실루엣.', 59900, 'F', 'B', 'SK', '432733_1.png', '432733_2.png', '432733_3.png', '432733_4.png', '432733_5.png');

INSERT INTO product
VALUES ('431464', 'U데님펜슬롱스커트', '스트레치 소재로 움직임이 편안한 데님 펜슬 롱 스커트. 13온스의 카이하라 데님 원단 사용. 유니클로 파리 RD센터의 아티스틱 디렉터 크리스토퍼 르메르(Christophe Lemaire)가 혁신적인 소재와 현대적인 디자인으로 재해석한 Uniqlo U 컬렉션입니다. 미니멀하고 세련된 슬림한 실루엣에 프런트 슬릿을 추가.', 49900, 'F', 'B', 'SK', '431464_1.png', '431464_2.png', '431464_3.png', '431464_4.png', '431464_5.png');
...
INSERT INTO cart 
VALUES (cart_cart_no_SEQ.nextval, 1, 39900, 'M', 'uni1', 418873);

INSERT INTO cart  
VALUES (cart_cart_no_SEQ.nextval, 3, 299700, 'S', 'uni2', 429094);
...
INSERT INTO jumun_detail 
VALUES (jumun_detail_jumun_d_no_SEQ.nextval, '울트라스트레치진20FW', 'S', 49900, 1, 2, 429094);

INSERT INTO jumun_detail
VALUES (jumun_detail_jumun_d_no_SEQ.nextval, '플란넬체크셔츠(긴팔)', 'L', 29900, 1, 3, 429094);
