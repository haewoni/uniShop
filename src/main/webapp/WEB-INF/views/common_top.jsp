...
<body>
	...
	<div class="offcanvas-container" id="shop-categories">
		...
		<nav class="offcanvas-menu">
			<ul class="menu">
				<li class="has-children"><span><a href="#">여성 상의</a><span
				...
				<li class="has-children"><span><a href="#">여성 하의</a><span
						class="sub-menu-toggle"></span></span>
					<ul class="offcanvas-submenu">
						<li><a href="shop_female_longpants_list">여성 긴바지</a></li>
						<li><a href="shop_female_skirt_list">여성 스커트</a></li>
					</ul></li>
				<li class="has-children"><span><a href="#">남성 상의</a><span
						class="sub-menu-toggle"></span></span>
					<ul class="offcanvas-submenu">
				...
				<li class="has-children"><span><a href="#">남성 하의</a><span
						class="sub-menu-toggle"></span></span>
					<ul class="offcanvas-submenu">
	...
	<div class="offcanvas-container" id="mobile-menu">
		<a class="account-link" href="account-orders.html">
			<div class="user-info">
				<h6 class="user-name">${loginMember.member_name}</h6>
				<span class="text-sm text-white opacity-60"></span>
			</div>
		</a>
		<nav class="offcanvas-menu">
			<ul class="menu">
				<li class="has-children"><span><a href="unishop_main"><span>Home</span></a><span
						class="sub-menu-toggle"></span></span>
					<ul class="offcanvas-submenu">
				...
				<li class="has-children"><span><a href="shop_main"><span>Shop</span></a><span
						class="sub-menu-toggle"></span></span>
					<ul class="offcanvas-submenu">
				...
				<li class="has-children"><span><a href="#">카테고리</a><span
						class="sub-menu-toggle"></span></span>
					<ul class="offcanvas-submenu">
			...
			<div class="lang-currency-switcher-wrap">
				<div class="lang-currency-switcher dropdown-toggle">
					<span class="language"><img alt="English"
						src="IMAGE/korea_flag.jpg"></span><span class="currency">
						WON (₩)</span>
				</div>
		...
		<div class="site-branding">
			<div class="inner">
				...
				<a class="offcanvas-toggle menu-toggle" href="#mobile-menu"
					data-toggle="offcanvas"></a>
				<!-- Site Logo-->
				<a class="site-logo" href="unishop_main"><img
				...
				<li class="active">
				    <c:choose>
						<c:when test="${empty sMemberId}">
							<a href="member_login_register_form"><span>Account</span></a>
						</c:when>
						<c:otherwise>
							<a href="member_profile_form"><span>Account</span></a>
						</c:otherwise>
					</c:choose>
					<ul class="sub-menu">
						<c:choose>
			...
			<div class="inner">
				<div class="tools">
					...
					<div class="account">
						<c:choose>
							<c:when test="${empty sMemberId}">
								<a href="member_login_register_form"></a>
							</c:when>
							<c:otherwise>
								<a href="member_profile_form"></a>
							</c:otherwise>
						</c:choose>
						<i class="icon-head"></i>
						<ul class="toolbar-dropdown">
							<c:choose>
								...
								<c:otherwise>
									...
									<li><a href="member_logout_action"> <i
											class="icon-unlock"></i>Logout
									</a></li>
								</c:otherwise>
							</c:choose>
						</ul>
					...
					<c:choose>
						...
						<c:otherwise>
							<div class="cart">
								<a href="cart_list"></a><i class="icon-bag"></i><span
									class="count"></span><span class="subtotal">${cart_subtotal}</span>
								<div class="toolbar-dropdown">
									<c:forEach items="${cartList}" var="cart" begin="0" step="1"
										...
										<div class="dropdown-product-item">
											<span class="dropdown-product-remove"><i
												...
												href="shop_product_detail?product_no=${cart.product_no}"><img
												src="IMAGE/${cart.product_image_1}" alt="Product"></a>
											<div class="dropdown-product-info">
												<a class="dropdown-product-title"
													href="shop_product_detail?product_no=${cart.product_no}">${cart.product_name}</a><span
													class="dropdown-product-details">${cart.cart_qty} x
													${cart.cart_tot_price}</span>
											</div>
										</div>
									</c:forEach>
									<div class="toolbar-dropdown-group">
										...
										<div class="column text-right">
											<span class="text-lg text-medium">${cart_subtotal}
												&nbsp;</span>
										</div>
									</div>
									<div class="toolbar-dropdown-group">
										<div class="column">
											<a class="btn btn-sm btn-block btn-secondary"
												href="cart_list">장바구니</a>
										</div>
										<div class="column">
											<a class="btn btn-sm btn-block btn-success"
												href="jumun_address_form">결제</a>
										</div>
									</div>
								</div>
							</div>
